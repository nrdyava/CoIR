...
from src.datasets.lasco.lasco_corpus_dataset import lasco_corpus_dataset_clip
from src.datasets.lasco.lasco_retrieval_dataset import lasco_retrieval_dataset_clip
