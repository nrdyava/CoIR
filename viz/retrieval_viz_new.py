...
def get_label(current_sample, rank):
    ret_id = current_sample['top_1000_ret_cands'][rank-1]
...
with ret1:
    st.image(load_image(get_image_path(current_sample['top_1000_ret_cands'][0])), caption=get_label(current_sample, 1), use_column_width=True)

with ret2:
    st.image(load_image(get_image_path(current_sample['top_1000_ret_cands'][1])), caption=get_label(current_sample, 2), use_column_width=True)

with ret3:
    st.image(load_image(get_image_path(current_sample['top_1000_ret_cands'][2])), caption=get_label(current_sample, 3), use_column_width=True)
    
with ret4:
    st.image(load_image(get_image_path(current_sample['top_1000_ret_cands'][3])), caption=get_label(current_sample, 4), use_column_width=True)

with ret5:
    st.image(load_image(get_image_path(current_sample['top_1000_ret_cands'][4])), caption=get_label(current_sample, 5), use_column_width=True)
    
with ret6:
    st.image(load_image(get_image_path(current_sample['top_1000_ret_cands'][5])), caption=get_label(current_sample, 6), use_column_width=True)

with ret7:
    st.image(load_image(get_image_path(current_sample['top_1000_ret_cands'][6])), caption=get_label(current_sample, 7), use_column_width=True)

with ret8:
    st.image(load_image(get_image_path(current_sample['top_1000_ret_cands'][7])), caption=get_label(current_sample, 8), use_column_width=True)
    
with ret9:
    st.image(load_image(get_image_path(current_sample['top_1000_ret_cands'][8])), caption=get_label(current_sample, 9), use_column_width=True)

with ret10:
    st.image(load_image(get_image_path(current_sample['top_1000_ret_cands'][9])), caption=get_label(current_sample, 10), use_column_width=True)
