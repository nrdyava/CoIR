...
from src.datasets.MT_3en_F_MG_img_caps_dataset import dataset as MT_3en_F_MG_img_caps_dataset
...
class DataModule(LightningDataModule):
    ...
    def setup(self, stage):
        if stage == 'fit':
            self.train_dataset = MT_3en_F_MG_img_caps_dataset(self.config, 'train')
            self.val_dataset = MT_3en_F_MG_img_caps_dataset(self.config, 'val')
