...
from src.datasets.flava_inbatch_2en import dataset as flava_inbatch_2en_dataset
...
class DataModule(LightningDataModule):
    ...
    def setup(self, stage):
        if stage == 'fit':
            self.train_dataset = flava_inbatch_2en_dataset(self.config, 'train')
            self.val_dataset = flava_inbatch_2en_dataset(self.config, 'val')
