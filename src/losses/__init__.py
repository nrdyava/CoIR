from src.losses.losses import BCE_loss_of_dotps, vanilla_constrastive_cross_entrpy_loss, cosine_embedding_loss, BCE_loss_of_dotps_ns, symmetric_loss_without_temp
