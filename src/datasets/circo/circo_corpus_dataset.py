...
class circo_corpus_dataset_clip(Dataset):
    def __init__(self, dataset_split, lasco_data_path, clip_ckpt_path):
        ...
        if dataset_split == 'test':
            corpus = json.load(open(os.path.join(lasco_data_path, 'metadata', 'corpus.json'), 'r'))
...
class circo_corpus_dataset_flava(Dataset):
