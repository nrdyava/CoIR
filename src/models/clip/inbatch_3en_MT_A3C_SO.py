...
class CLIPModel(L.LightningModule):
    ...
    def training_step(self, batch, batch_idx):
        ...
        if self.gather_embeddings and dist.is_initialized():
            ...
            loss_instruct_1 = self.loss_fn_instruct(query_text_embeds, instruct_1_hat)
            loss_instruct_2 = self.loss_fn_instruct(target_image_embeds, instruct_2_hat)
            loss_instruct_3 = self.loss_fn_instruct(query_image_embeds, instruct_3_hat)
